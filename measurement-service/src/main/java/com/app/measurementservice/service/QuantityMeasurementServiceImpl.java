...
import com.app.measurementservice.core.Quantity;
...
import com.app.measurementservice.entity.QuantityModel;
import com.app.measurementservice.exception.QuantityMeasurementException;
import com.app.measurementservice.model.*;
import com.app.measurementservice.repository.IQuantityMeasurementRepository;
...
/**
 * UC18 – Service implementation (migrated from monolith, package updated only).
 */
@Service
public class QuantityMeasurementServiceImpl implements IQuantityMeasurementService {
    ...
    public QuantityMeasurementServiceImpl(IQuantityMeasurementRepository repository) {
        ...
        logger.info("QuantityMeasurementServiceImpl initialized (measurement-service)");
    }
    ...
    private QuantityMeasurementEntity buildEntity(
            QuantityModel<IMeasurable> m1, QuantityModel<IMeasurable> m2,
            String operation, String resultString,
            QuantityModel<IMeasurable> resultModel, boolean isError, String errorMessage) {
    ...
    public QuantityMeasurementDTO compare(QuantityDTO dto1, QuantityDTO dto2) {
        ...
        try {
            if (!m1.getUnit().getClass().equals(m2.getUnit().getClass())) {
                QuantityMeasurementEntity e = buildEntity(m1, m2, "COMPARE", "Not Equal", null, false, null);
                return QuantityMeasurementDTO.fromEntity(repository.save(e));
            }
            boolean equal = Math.abs(
                    m1.getUnit().convertToBaseUnit(m1.getValue()) -
                    m2.getUnit().convertToBaseUnit(m2.getValue())) <= 1e-5;
            QuantityMeasurementEntity e = buildEntity(m1, m2, "COMPARE", equal ? "Equal" : "Not Equal", null, false, null);
            return QuantityMeasurementDTO.fromEntity(repository.save(e));
        } catch (Exception ex) {
            QuantityMeasurementEntity e = buildEntity(m1, m2, "COMPARE", null, null, true, ex.getMessage());
            return QuantityMeasurementDTO.fromEntity(repository.save(e));
        }
    }
    ...
    public QuantityMeasurementDTO convert(QuantityDTO dto, String targetUnitName) {
        ...
        try {
            ...
            QuantityMeasurementEntity e = buildEntity(m, null, "CONVERT", null, resultModel, false, null);
            return QuantityMeasurementDTO.fromEntity(repository.save(e));
        } catch (Exception ex) {
            QuantityMeasurementEntity e = buildEntity(m, null, "CONVERT", null, null, true, ex.getMessage());
            return QuantityMeasurementDTO.fromEntity(repository.save(e));
        }
    }

    @Override public QuantityMeasurementDTO add(QuantityDTO dto1, QuantityDTO dto2) { return add(dto1, dto2, dto1.getUnit()); }
    ...
    public QuantityMeasurementDTO add(QuantityDTO dto1, QuantityDTO dto2, String targetUnitName) {
        ...
        try {
            ...
            QuantityMeasurementEntity e = buildEntity(m1, m2, "ADD", null, resultModel, false, null);
            return QuantityMeasurementDTO.fromEntity(repository.save(e));
        } catch (Exception ex) {
            QuantityMeasurementEntity e = buildEntity(m1, m2, "ADD", null, null, true, ex.getMessage());
            return QuantityMeasurementDTO.fromEntity(repository.save(e));
        }
    }

    @Override public QuantityMeasurementDTO subtract(QuantityDTO dto1, QuantityDTO dto2) { return subtract(dto1, dto2, dto1.getUnit()); }
    ...
    public QuantityMeasurementDTO subtract(QuantityDTO dto1, QuantityDTO dto2, String targetUnitName) {
        ...
        try {
            ...
            QuantityModel<IMeasurable> resultModel = new QuantityModel<>(result.getValue(), result.getUnit());
            QuantityMeasurementEntity e = buildEntity(m1, m2, "SUBTRACT", null, resultModel, false, null);
            return QuantityMeasurementDTO.fromEntity(repository.save(e));
        } catch (Exception ex) {
            QuantityMeasurementEntity e = buildEntity(m1, m2, "SUBTRACT", null, null, true, ex.getMessage());
            return QuantityMeasurementDTO.fromEntity(repository.save(e));
        }
    }
    ...
    public QuantityMeasurementDTO divide(QuantityDTO dto1, QuantityDTO dto2) {
        ...
        try {
            ...
            QuantityMeasurementEntity e = buildEntity(m1, m2, "DIVIDE", String.valueOf(result), null, false, null);
            return QuantityMeasurementDTO.fromEntity(repository.save(e));
        } catch (Exception ex) {
            QuantityMeasurementEntity e = buildEntity(m1, m2, "DIVIDE", null, null, true, ex.getMessage());
            return QuantityMeasurementDTO.fromEntity(repository.save(e));
        }
    }
    ...
    @Override public List<QuantityMeasurementDTO> getAllMeasurements()             { return QuantityMeasurementDTO.fromEntityList(repository.findAll()); }
    @Override public List<QuantityMeasurementDTO> getMeasurementsByOperation(String op) { return QuantityMeasurementDTO.fromEntityList(repository.findByOperation(op.toUpperCase())); }
    @Override public List<QuantityMeasurementDTO> getMeasurementsByType(String type)   { return QuantityMeasurementDTO.fromEntityList(repository.findByThisMeasurementType(type)); }
    @Override public List<QuantityMeasurementDTO> getErrorHistory()                { return QuantityMeasurementDTO.fromEntityList(repository.findByIsError(true)); }
    @Override public long getOperationCount(String operation)                      { return repository.countByOperationAndIsErrorFalse(operation.toUpperCase()); }
}
